...
export async function reset (req, res, { isV3 = false }) {
  ...
  const tasks = await Tasks.Task.find({
    userId: user._id,
    //RULEKEEPER PARSER...Tasks.taskIsGroupOrChallengeQuery,
  ...
  res.respond(200, resetRes); //RULEKEEPER PARSER
}
...
export async function reroll (req, res, { isV3 = false }) {
  ...
  res.respond(200, rerollRes); //RULEKEEPER PARSER
}
...
export async function rebirth (req, res, { isV3 = false }) {
  ...
  res.respond(200, rebirthRes); //RULEKEEPER PARSER
}
