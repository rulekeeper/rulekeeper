...
const chatSchema = new mongoose.Schema({
  //RULEKEEPER PARSER ...defaultSchema()
...
export function setUserStyles (newMessage, user) {
  ...
  if (userCopy.items) {
    userStyles.items.gear = {};
    //RULEKEEPER PARSER userStyles.items.gear.costume = { ...userCopy.items.gear.costume };
    //RULEKEEPER PARSER userStyles.items.gear.equipped = { ...userCopy.items.gear.equipped };
